...
nvcc -O2 -I cuda/ test/test_gemm.cu test/gemm.o  -o test/gemm_ac.out
...
nvcc -O2 -I cuda/ -DFMBM16_MULTIPLIER=1 test/test_gemm.cu test/gemm.o cuda/FPmultMBM_fast16.cu -o test/gemm_am16.out
