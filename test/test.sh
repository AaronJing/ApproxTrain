...
nvcc -O2 -I cuda/ -rdc=true -DFMBM16_MULTIPLIER=1 -c cuda/gemm.cu -o test/gemm.o
nvcc -O2 -I cuda/ -DFMBM16_MULTIPLIER=1 test/test_gemm.cu test/gemm.o test/FPmultMBM_fast16.o -o test/gemm_am16.out
