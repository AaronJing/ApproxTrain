...
/*
  REGISTER_KERNEL_BUILDER(Name("MatMulAM")                           \
                              .Device(DEVICE_GPU)                  \
TF_CALL_GPU_NUMBER_TYPES                              .TypeConstraint<T>("T")              \
                              .Label("cublas"),                    \
                          MatMulAMOp<GPUDevice, T, true>)
*/
