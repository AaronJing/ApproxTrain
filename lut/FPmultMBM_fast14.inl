...
// MANTISSA_TRUNC_MASK  (2^5-1)*2^18 :  {9{0}, 5{1}, 18{0}}
// MANTISSA_TRUNC_SETBIT   2^8     :   {13{0}, 1{1}, 18{0}}
//********************************************************************************************************************************************
uint32_t fn_mul_mbmmant14(uint32_t Amnt, uint32_t Bmnt)
{
	...
	CorrTem = (655360 >> carry) & MANTISSA_TRUNC_MASK;    // constant:  (2^-4+2^-6 x 2^23): in fixed point 9_23 : get rid of 20 bits

	Smnt_corr = (Smnt & MANTISSA_MASK) + (CorrTem);
...
//********************************************************************************************************************************************
float FPmultMBM_fast14(float Af, float Bf)
{
    // type casting
	...
	uint32_t Mbm_mantmult = fn_mul_mbmmant14(Amnt, Bmnt);  // Passing without hidden bit
