...
#define MANTISSA_TRUNC_MASK       7340032
#define MANTISSA_TRUNC_SETBIT     1048576
#define INPUT12_MASK 0xfff00000

// MANTISSA_MASK: 2^23 - 1          :     {9{0}, 23{1}}
// MANTISSA_MASK_INV: 511*2^23      :    {9{1}, 23{0}}
// EXPONENT_MASK:    255^2^23       : {0, 8{1}, 23{0}}
// SIGN MASK             2^31       :  {1, 31{0}}
// MANTISSA_TRUNC_MASK  (2^3-1)*2^20 :  {9{0}, 3{1}, 20{0}}
// MANTISSA_TRUNC_SETBIT   2^20     :   {11{0}, 1{1}, 20{0}}


//********************************************************************************************************************************************
uint32_t fn_mul_mitchmant12(uint32_t Amnt, uint32_t Bmnt)
{
	...
	Smnt      = (Amnt & MANTISSA_TRUNC_MASK) + (Bmnt & MANTISSA_TRUNC_MASK);
	carry     = (Smnt >= 8388608);     //2^23 = 8388608 <==>  x1+x2>1;
	Smnt_corr = (Smnt & MANTISSA_MASK);
...
//********************************************************************************************************************************************
float FPmultMitch_fast12(float Af, float Bf)
{
    // type casting
	...
	uint32_t Mbm_mantmult = fn_mul_mitchmant12(Amnt, Bmnt);  // Passing without hidden bit
