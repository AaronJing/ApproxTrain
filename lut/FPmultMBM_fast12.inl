...
//********************************************************************************************************************************************
uint32_t fn_mul_mbmmant12(uint32_t Amnt, uint32_t Bmnt)
{
...
//********************************************************************************************************************************************
float FPmultMBM_fast12(float Af, float Bf)
{
    // type casting
	...
	uint32_t Mbm_mantmult = fn_mul_mbmmant12(Amnt, Bmnt);  // Passing without hidden bit
