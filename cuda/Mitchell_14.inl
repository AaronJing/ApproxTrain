...
// MANTISSA_TRUNC_SETBIT   2^18     :   {13{0}, 1{1}, 18{0}}


//********************************************************************************************************************************************
__device__ uint32_t fn_mul_mitchmant14(uint32_t Amnt, uint32_t Bmnt)
{
...
//********************************************************************************************************************************************
__device__ float FPmultMitch_fast14(float Af, float Bf)
{
    // type casting
	...
	uint32_t Mbm_mantmult = fn_mul_mitchmant14(Amnt, Bmnt);  // Passing without hidden bit
