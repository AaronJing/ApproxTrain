...
//********************************************************************************************************************************************
__device__  uint32_t fn_mul_mitchmant32(uint32_t Amnt, uint32_t Bmnt)
{
...
//********************************************************************************************************************************************
__device__ float FPmultMitch_fast32(float Af, float Bf)
{
    // type casting
	...
	uint32_t Mbm_mantmult = fn_mul_mitchmant32(Amnt, Bmnt);  // Passing without hidden bit
